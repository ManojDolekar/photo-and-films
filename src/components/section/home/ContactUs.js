  ...
  const contactInfo = [
    {
      ...
      title: "Email Us",
      content: "photofilms@gmail.com",
      bgColor: "#F5F7FA",
      href: "photofilms@gmail.com",
      target: "_blank"
    },
    {
      icon: <Phone className="h-8 w-8 text-[#2C3E50]" />,
      title: "Call Us",
      content: "+91 8795461234",
      bgColor: "#F5F7FA",
      href: "tel:8795461234",
      target: "_blank"
    },
...

    {
      ...
      bgColor: "#F5F7FA",
      href: "https://www.instagram.com/photo_photography22?igsh=aXI2N2l4dHZqN3d2",
      target: "_blank"
    },
  ];
