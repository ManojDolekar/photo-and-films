...
import manoj from '../../../common/asset/suraj.jpeg'
function AboutUs() {
    return (
        <div className=' flex flex-col   xl:pt-2 pt-14 lg:justify-evenly items-center w-full bg-white  xl:my-12 '>
            ...
            <div className='p-5 flex flex-col lg:flex-row items-center w-full justify-between xl:w-[70%]'>
                <div className='lg:w-[60%]'>
                    <img src={manoj} className='h-[300px] w-[300px] lg:h-[400px] lg:w-[400px] xl:h-[500px] xl:w-[500px] ' style={{ objectFit: 'cover', objectPosition: 'bottom' }} alt="" loading='lazy' />
                </div>
                <div className=' lg:w-[40%] space-y-1'>
                    <div className='p-2'>
                        <h2 className='font-belleza-regular tracking-widest text-center font-bold text-2xl uppercase'>Manoj Dolekar</h2>
